import { IconCards, IconHelpSquareRounded, IconSmartHome, IconMessageChatbot, IconBook } from "@tabler/icons-react";
...
const Sidebar = () => {
    return (
        <ul className="flex flex-col gap-[50px] ">
            ...
            <SidebarItem link={"/reading"} svgIcon={IconBook} size={33} stroke={1.5} color="#003B8C" label={"Reading"} />
